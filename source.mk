...
SRC_LIB_GRAPHIC_NCURSES		=	$(SRC_LIB_GRAPHIC_NCURSES_DIR)GraphicMenu.cpp			\
								...
								$(SRC_LIB_GRAPHIC_NCURSES_DIR)SnakeGraph.cpp			\
...
SRC_LIB_GRAPHIC_SFML		=	$(SRC_LIB_GRAPHIC_SFML_DIR)GraphicMenu.cpp				\
								...
								$(SRC_LIB_GRAPHIC_SFML_DIR)SnakeGraph.cpp			\
...
SRC_LIB_GAME_SNAKE		=	$(SRC_LIB_GAME_SNAKE_DIR)GameCore.cpp		\
							$(SRC_LIB_GAME_SNAKE_DIR)SnakeCore.cpp		\
							$(SRC_LIB_GAME_SNAKE_DIR)SnakePart.cpp		\
							$(SRC_LIB_GAME_SNAKE_DIR)SnakeGame.cpp
...
SRC_LIB_GAME_PACMAN		=	$(SRC_LIB_GAME_PACMAN_DIR)GameCore.cpp		\
							$(SRC_LIB_GAME_PACMAN_DIR)APCharacter.cpp		\
							$(SRC_LIB_GAME_PACMAN_DIR)Pacman.cpp		\
							$(SRC_LIB_GAME_PACMAN_DIR)Ghost.cpp		\
